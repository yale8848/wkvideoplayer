...
public class MediaController extends FrameLayout implements SeekBar.OnSeekBarChangeListener, View.OnClickListener {
    ...
    private void initView(Context context) {
        ...
        mTextViewTitle = (TextView) findViewById(R.id.tv_tilte);
        mLinearLayoutTop = (LinearLayout) findViewById(R.id.ll_top);
        mTextViewCenter = (TextView) findViewById(R.id.tv_text_center);
        initData();
    }
