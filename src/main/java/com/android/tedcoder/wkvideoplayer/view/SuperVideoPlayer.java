...
import com.android.tedcoder.wkvideoplayer.controller.TouchEventController;
...
public class SuperVideoPlayer extends RelativeLayout {
    ...
    public MediaController.MediaControlImpl getMediaControlImpl(){
...
/*    @Override
    public boolean onTouchEvent(MotionEvent event) {
        ...
        return mTouchEventController.onTouchEvent(event);
    }*/
    ...
    private TouchEventController mTouchEventController = null;

    private void initView(Context context) {
        mContext = context;

        mTouchEventController = new TouchEventController(mContext,this);
        mTouchEventController.setTouchCallBack(new TouchEventController.TouchCallBack() {
            @Override
            public void centerText(String text) {

                mMediaController.getTextViewCenter().setText(text);
            }
...
/*            mMediaController.clearAnimation();
    ...
    public void setTitle(String text){
        mMediaController.setTitle(text);
    }
